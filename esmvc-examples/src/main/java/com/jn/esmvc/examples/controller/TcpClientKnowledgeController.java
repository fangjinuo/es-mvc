...
@RestController
@RequestMapping("/tcp/knowledges")
public class TcpClientKnowledgeController {
    private ESTcpKnowledgeService knowledgeService;
    ...
    @Autowired
    public void setKnowledgeService(ESTcpKnowledgeService knowledgeService) {
